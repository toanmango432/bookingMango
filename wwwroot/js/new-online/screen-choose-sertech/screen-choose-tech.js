        ...
        <div class="wrap-content-salon">
            ...
            <div class="content-choose-sertech">
                <div class="choose-ptechs">
                    ...
                    <div class="wrap-search-tech ${isMobile ? "mt-0" : "mt-3"}">
...
$(document).ready(async function () {
  ...
  $(document).on("click", ".item-tech-sctpage", async function () {
    ...
    renderListStaff_PageChooseTech(listStaff);
  ...
  $(document).on("click", "#show-timeof-tech", async function (e) {
    ...
    if (staff.offDay) {
      ...
      const cusStyle = `max-height: 400px;
      overflow-y:scroll;`;
  ...
  $(document).on("click", ".desc-staff", function () {
    const $this = $(this);
    ...
    const infoUser = listStaffUser.find((sf) => sf.employeeID === employeeID);
    if (!infoUser?.desc) return;
